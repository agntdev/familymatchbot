...
export interface Session {
  step?: "idle" | "rules" | "consent" | "name" | "age" | "gender" | "city" | "photos" | "marital" | "nationality" | "nationality_manual" | "profession" | "height" | "about" | "purpose" | "telegram" | "telegram_manual" | "preview" | "message" | "report" | "edit_field" | "edit_bio" | "search_age_from" | "search_age_to" | "search_city" | "admin_search";
  draft?: { name?: string; age?: number; city?: string; photos?: string[]; gender?: string; maritalStatus?: string; nationality?: string | null; profession?: string; height?: number; bio?: string; purpose?: string; preferredAgeFrom?: number; preferredAgeTo?: number; preferredGender?: string; telegramUsername?: string | null; usernameConfirmed?: boolean; rulesAccepted?: boolean };
...
export async function buildBot(token: string, opts: BuildBotOptions = {}) {
  ...
  bot.on("message", (ctx) => ctx.reply("Я не совсем понял(а) сообщение. Откройте /start и выберите нужную кнопку."));
